...
EOF
    ...
    cat > ../../docs/deployment/DOKPLOY_DEPLOYMENT_GUIDE.md << EOF
...
- Security testing: Run tests/integration/test_secure_client.py after deployment
EOF

    print_success "Deployment instructions created: ../../docs/deployment/DOKPLOY_DEPLOYMENT_GUIDE.md"
    echo
...
EOF
    ...
    echo "  📄 ../../docs/deployment/DOKPLOY_DEPLOYMENT_GUIDE.md - Step-by-step guide"
    ...
    echo "  3. Follow DOKPLOY_DEPLOYMENT_GUIDE.md"
